...
bool st_run_pagestrap_tests() {
  ...
  // Basic allocation
  pagestrap_add_pages(&pagestrap, (vptr)0x2000, 1);
  pagestrap_add_pages(&pagestrap, (vptr)0x4000, 1);
  ...
  pagestrap_add_pages(&pagestrap, (vptr)0x7000, 2);
  ...
  // Remove tail end
  pagestrap_add_pages(&pagestrap, (vptr)0x9000, 2);
  pagestrap_remove_pages(&pagestrap, (vptr)0xA000, 1);
  ...
  // Remove head
  pagestrap_add_pages(&pagestrap, (vptr)0xC000, 2);
  pagestrap_remove_pages(&pagestrap, (vptr)0xC000, 1);
  ...
  // Remove middle
  pagestrap_add_pages(&pagestrap, (vptr)0x10000, 3);
  pagestrap_remove_pages(&pagestrap, (vptr)0x11000, 1);
  ...
  // Remove all
  pagestrap_add_pages(&pagestrap, (vptr)0x14000, 4);
  pagestrap_remove_pages(&pagestrap, (vptr)0x14000, 4);
